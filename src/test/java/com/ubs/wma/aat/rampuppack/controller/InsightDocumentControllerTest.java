...
class InsightDocumentControllerTest {
    ...
    void getByAceIdReturnsTheDocumentIncludingHtml() {
        ...
        webTestClient
                .get()
                .uri("/api/v1/insight-documents/ACE-1001")
                .exchange()
                .expectStatus()
                .isOk()
                .expectBody()
                .jsonPath("$.aceId")
                .isEqualTo("ACE-1001")
                .jsonPath("$.leadClientName")
                .isEqualTo("John Smith Household")
                .jsonPath("$.fileName")
                .isEqualTo("John_Smith_Household.html")
                .jsonPath("$.htmlContent")
                .isEqualTo("<html><body>pack</body></html>");
    }

    @Test
    void unknownAceIdReturns404ProblemDetail() {
        given(service.findByAceId("ACE-NOPE"))
                .willReturn(Mono.error(new ResourceNotFoundException("STAAT insight document for ACE id", "ACE-NOPE")));

        webTestClient
                .get()
                .uri("/api/v1/insight-documents/ACE-NOPE")
                .exchange()
                .expectStatus()
                .isNotFound()
                .expectHeader()
    ...
    void listByAceIdsBindsTheCommaSeparatedParameter() {
        given(service.findByAceIds(List.of("ACE-1001", "ACE-1002")))
        ...
        webTestClient
                .get()
                .uri("/api/v1/insight-documents?aceIds=ACE-1001,ACE-1002")
                .exchange()
                .expectStatus()
                .isOk()
                .expectBody()
