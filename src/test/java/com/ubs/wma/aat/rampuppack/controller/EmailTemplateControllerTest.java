...
class EmailTemplateControllerTest {
    ...
    void listForwardsTheActiveFilter() {
        ...
        webTestClient
                .get()
                .uri("/api/v1/email-templates?active=true")
                .exchange()
                .expectStatus()
                .isOk();
    ...
    void getUnknownIdReturns404ProblemDetail() {
        ...
        webTestClient
                ...
                .isEqualTo(404)
                .jsonPath("$.detail")
                .isEqualTo("Email template with id 99 was not found");
    }
    ...
    static Stream<Arguments> invalidTemplateBodies() {
        return Stream.of(
                ...
                arguments(
                        ...
                        "body"),
                arguments(
                        "code over the 100-character limit",
                        """
    ...
    void invalidCreateRequestsAreRejectedWithoutReachingTheService(
    ...
    void duplicateCodeMapsTo409DataConflict() {
        given(service.create(any()))
                .willReturn(Mono.error(new DataIntegrityViolationException("duplicate key email_template_code_key")));
